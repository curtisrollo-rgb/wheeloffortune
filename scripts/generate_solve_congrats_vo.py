#!/usr/bin/env python3
"""Generate random solve-congratulation voiceovers (ElevenLabs v3)."""
...
CONFIG_PATH = ROOT / "data" / "vo-solve-congrats.json"
OUT_DIR = ROOT / "assets" / "audio" / "vo" / "solve-congrats"
...
def main() -> None:
    ...
    prefix = config.get("tag_prefix", "[Congratulatory] [Good mood]")
    lines = config["lines"]
        ...
        manifest["clips"].append(
            {
                ...
                "text": line["text"],
                "spoken": spoken,
                "file": f"assets/audio/vo/solve-congrats/{line['id']}.mp3",
            }
        )
        time.sleep(0.35)
