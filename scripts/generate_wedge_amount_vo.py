#!/usr/bin/env python3
"""Generate wedge dollar-amount voiceovers (ElevenLabs v3)."""
...
CONFIG_PATH = ROOT / "data" / "vo-wedge-amounts.json"
OUT_DIR = ROOT / "assets" / "audio" / "vo" / "wedge-amounts"
...
def main() -> None:
    ...
    prefix = config.get("tag_prefix", "[matter of factly]")
        ...
        manifest["clips"].append(
            {
                ...
                "text": line["text"],
                "spoken": spoken,
                "file": f"assets/audio/vo/wedge-amounts/{line['id']}.mp3",
            }
        )
        time.sleep(0.35)
